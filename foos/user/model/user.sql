...
CREATE TABLE IF NOT EXISTS `t_user_info` (
  ...
  `uid` char(32) NOT NULL COMMENT 'UID',
...
CREATE TABLE IF NOT EXISTS `t_user_relation` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `user_relation_uniq_uid` (`uid`) USING BTREE
